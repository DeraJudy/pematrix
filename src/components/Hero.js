...
//             className="font-display text-3xl sm:text-5xl md:text-6xl lg:text-7xl font-bold md:font-black 
//             leading-tight mb-6"
//           >
//             Build, Scale, and{" "}
...
//               }}
//               className="inline-flex items-center gap-2 rounded-xl px-6 py-4 font-bold hover:text-xl"
//             >
//               Start Your Project
...
//             <a
//               href="#services"
//               className="font-bold px-8 py-4 border rounded-xl hover:border-3"
//               style={{
